...
const generateStudentReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const report = yield prisma_1.prisma.studentTermReport.findUnique({
            where: {
                studentId_termId: {
                    studentId,
                    termId
...
const getClassReports = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const termReports = yield prisma_1.prisma.studentTermReport.findMany({
            where: {
...
const generateSingleStudentReport = (studentId, termId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const term = yield prisma_1.prisma.academicTerm.findUnique({
        where: { id: termId }
    });
    if (!term)
        return;
    ...
    const gradingScales = yield prisma_1.prisma.gradingScale.findMany({
    ...
    for (const subjectId in subjectAssessments) {
        ...
        yield prisma_1.prisma.termResult.upsert({
            where: {
    ...
    const attendanceCount = yield prisma_1.prisma.attendance.count({
        where: {
            studentId,
            date: {
                gte: term.startDate,
    ...
    const schoolDays = yield prisma_1.prisma.attendance.groupBy({
        by: ['date'],
        where: {
            classId: student.classId,
            date: {
    ...
    yield prisma_1.prisma.studentTermReport.upsert({
        where: {
            studentId_termId: {
                studentId,
                termId
...
const updateReportRemarks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const report = yield prisma_1.prisma.studentTermReport.update({
            where: {
                studentId_termId: {
                    studentId,
                    termId
