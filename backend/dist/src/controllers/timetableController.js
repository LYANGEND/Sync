...
exports.getAllPeriods = exports.updateTimetablePeriod = exports.deleteTimetablePeriod = exports.createTimetablePeriod = exports.getTimetableByTeacher = exports.getTimetableByClass = void 0;
...
const createPeriodSchema = zod_1.z.object({
    ...
    teacherId: zod_1.z.string().uuid().optional(), // Optional - will look up from TeacherSubject allocation
...
const getTimetableByClass = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const periods = yield prisma_1.prisma.timetablePeriod.findMany({
            where: {
...
const createTimetablePeriod = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!teacherId) {
            const allocation = yield prisma_1.prisma.teacherSubject.findFirst({
            ...
            if (!allocation) {
                ...
                return res.status(400).json({
                    message: `No teacher allocated for "${(subject === null || subject === void 0 ? void 0 : subject.name) || 'Unknown'}" in this class. Please use Subject Allocation first.`
                });
            }
            teacherId = allocation.teacherId;
        }
        // 1. Check for Teacher Conflict
        const teacherConflict = yield prisma_1.prisma.timetablePeriod.findFirst({
            where: {
                teacherId,
                dayOfWeek,
                academicTermId,
        ...
        for (const classId of classIds) {
            const classConflict = yield prisma_1.prisma.timetablePeriod.findFirst({
                where: {
                    dayOfWeek,
                    academicTermId,
                    classes: {
...
const deleteTimetablePeriod = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield prisma_1.prisma.timetablePeriod.delete({
            where: { id },
        });
        res.status(204).send();
    }
...
const updateTimetablePeriod = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        ...
        const period = yield prisma_1.prisma.timetablePeriod.update({
            where: { id },
            data,
            include: {
                subject: true,
...
exports.updateTimetablePeriod = updateTimetablePeriod;
