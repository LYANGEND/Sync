...
exports.getGradebook = exports.getStudentResults = exports.getAssessmentResults = exports.recordResults = exports.bulkDeleteAssessments = exports.deleteAssessment = exports.updateAssessment = exports.getAssessmentById = exports.getAssessments = exports.createAssessment = void 0;
...
const updateAssessment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const assessment = yield prisma_1.prisma.assessment.update({
            where: { id },
            data: updateData,
...
const deleteAssessment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prisma_1.prisma.assessment.delete({ where: { id } });
        res.status(204).send();
    }
    catch (error) {
...
const bulkDeleteAssessments = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield prisma_1.prisma.assessment.deleteMany({
            where: { id: { in: ids } }
        });
...
const recordResults = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const operations = results.map(result => prisma_1.prisma.assessmentResult.upsert({
            where: {
...
const getAssessmentResults = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const results = yield prisma_1.prisma.assessmentResult.findMany({
