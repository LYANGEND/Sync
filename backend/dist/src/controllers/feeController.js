...
const getFeeTemplates = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const templates = yield prisma_1.prisma.feeTemplate.findMany({
            include: {
                academicTerm: true,
            },
            orderBy: {
...
const createFeeTemplate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const template = yield prisma_1.prisma.feeTemplate.create({
            data: {
                name,
                amount,
                academicTermId,
...
const assignFeeToClass = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const feeTemplate = yield prisma_1.prisma.feeTemplate.findUnique({
        ...
        for (const student of studentsToAssign) {
            try {
                ...
                const record = yield prisma_1.prisma.studentFeeStructure.create({
                    data: {
...
const getFeeTemplateById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const template = yield prisma_1.prisma.feeTemplate.findUnique({
            where: { id },
            include: {
                academicTerm: true,
            }
...
const updateFeeTemplate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const template = yield prisma_1.prisma.feeTemplate.update({
            where: { id },
            data,
        });
        res.json(template);
...
const deleteFeeTemplate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const usageCount = yield prisma_1.prisma.studentFeeStructure.count({
        ...
        yield prisma_1.prisma.feeTemplate.delete({
            where: { id },
        });
        res.status(204).send();
    }
...
const bulkCreateFeeTemplates = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield prisma_1.prisma.feeTemplate.createMany({
            data: dataToCreate,
            skipDuplicates: true,
        });
        res.status(201).json({
...
const getStudentStatement = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // 3. Get Fees (Debits)
        const fees = yield prisma_1.prisma.studentFeeStructure.findMany({
            where: { studentId },
            include: {
                feeTemplate: {
                    include: { academicTerm: true }
