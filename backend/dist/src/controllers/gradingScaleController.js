...
const getGradingScales = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const scales = yield prisma_1.prisma.gradingScale.findMany({
...
const createGradingScale = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Check for overlap
        const existing = yield prisma_1.prisma.gradingScale.findFirst({
            where: {
                OR: [
                    {
                        AND: [
        ...
        const scale = yield prisma_1.prisma.gradingScale.create({
            data,
        });
...
const updateGradingScale = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const data = gradingScaleSchema.parse(req.body);
        const scale = yield prisma_1.prisma.gradingScale.update({
            where: { id },
            data,
        });
        res.json(scale);
...
const deleteGradingScale = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        yield prisma_1.prisma.gradingScale.delete({
            where: { id },
        });
        res.status(204).send();
    }
