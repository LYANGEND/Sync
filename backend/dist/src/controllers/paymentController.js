...
const createPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const recentDuplicate = yield prisma_1.prisma.payment.findFirst({
            where: {
                studentId,
                amount,
                status: 'COMPLETED',
        ...
        (0, accountingBridge_1.onPaymentCreated)(payment.id, userId).catch(err => console.error('Background journal entry creation failed:', err));
...
const getPayments = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Branch Scoping:
        const user = req.user;
        if ((user === null || user === void 0 ? void 0 : user.role) !== 'SUPER_ADMIN' && (user === null || user === void 0 ? void 0 : user.branchId)) {
...
const getFinanceStats = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = req.user;
        const branchId = (user === null || user === void 0 ? void 0 : user.role) !== 'SUPER_ADMIN' ? user === null || user === void 0 ? void 0 : user.branchId : req.query.branchId;
        const whereStatus = { status: 'COMPLETED' };
        if (branchId)
            whereStatus.branchId = branchId;
        // 1. Total Revenue (Sum of COMPLETED payments only)
        const totalRevenueAgg = yield prisma_1.prisma.payment.aggregate({
            where: whereStatus,
            _sum: { amount: true },
            _count: { id: true },
        });
        ...
        const totalFeesAgg = yield prisma_1.prisma.studentFeeStructure.aggregate({
            _sum: { amountDue: true },
        });
        ...
        let revenueByBranch = [];
        if ((user === null || user === void 0 ? void 0 : user.role) === 'SUPER_ADMIN' && !branchId) {
            revenueByBranch = yield prisma_1.prisma.payment.groupBy({
                by: ['branchId'],
        ...
        // Enrich branch names
        const branches = yield prisma_1.prisma.branch.findMany({ select: { id: true, name: true } });
        ...
        // 4. Overdue Students Count
        // Get total due per student
        const feesByStudent = yield prisma_1.prisma.studentFeeStructure.groupBy({
            by: ['studentId'],
            _sum: { amountDue: true },
        });
        // Get total paid per student (COMPLETED only)
        const paymentsByStudent = yield prisma_1.prisma.payment.groupBy({
            by: ['studentId'],
            where: { status: 'COMPLETED' },
            _sum: { amount: true },
        });
        ...
        const whereRecent = {};
        if (branchId)
            whereRecent.branchId = branchId;
        const recentActivity = yield prisma_1.prisma.payment.findMany({
            where: whereRecent,
            take: 5,
            orderBy: { createdAt: 'desc' },
            include: {
...
const getFinancialReport = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const effectiveBranchId = (user === null || user === void 0 ? void 0 : user.role) !== 'SUPER_ADMIN' ? user === null || user === void 0 ? void 0 : user.branchId : branchId;
        ...
        const methodsStats = yield prisma_1.prisma.payment.groupBy({
            by: ['method'],
            where: paymentWhere,
            _count: { id: true },
            _sum: { amount: true }
...
const voidPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const voidingUser = yield prisma_1.prisma.user.findUnique({ where: { id: userId } });
        if (!voidingUser) {
        ...
        // Void the payment
        const voidedPayment = yield prisma_1.prisma.payment.update({
            where: { id: paymentId },
            data: {
                status: 'VOIDED',
                voidedAt: new Date(),
        ...
        (0, accountingBridge_1.onPaymentVoided)(paymentId, userId).catch(err => console.error('Background void journal creation failed:', err));
        res.json({
...
const checkDuplicatePayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const fiveMinutesAgo = new Date(Date.now() - 5 * 60 * 1000);
        const recentPayments = yield prisma_1.prisma.payment.findMany({
            where: {
                studentId: studentId,
...
const initiateMobileMoneyPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const collection = yield prisma_1.prisma.mobileMoneyCollection.create({
            data: {
                reference,
                studentId,
                amount: totalCharge,
        ...
        const pendingPayment = yield prisma_1.prisma.payment.create({
            data: {
                transactionId,
                studentId,
        ...
        yield prisma_1.prisma.mobileMoneyCollection.update({
        ...
        const updatedCollection = yield prisma_1.prisma.mobileMoneyCollection.update({
            where: { id: collection.id },
            data: {
...
const checkMobileMoneyStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const collection = yield prisma_1.prisma.mobileMoneyCollection.findUnique({
            where: { reference },
            include: {
                student: {
                    select: {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (newStatus === 'COMPLETED') {
                (0, accountingBridge_1.onPaymentCreated)(payment.id).catch(err => console.error('Background journal entry for mobile money failed:', err));
            }
...
const getMobileMoneyCollections = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const [collections, total] = yield Promise.all([
            ...
            prisma_1.prisma.mobileMoneyCollection.count({ where }),
        ]);
        res.json({
...
const getStudentForPublicPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Calculate Balance
        const totalFees = yield prisma_1.prisma.studentFeeStructure.aggregate({
            where: { studentId: student.id },
            _sum: { amountDue: true }
        });
        const totalPayments = yield prisma_1.prisma.payment.aggregate({
            where: {
