...
const baseStudentSchema = zod_1.z.object({
    ...
    branchId: zod_1.z.string().uuid().nullable().optional().or(zod_1.z.literal('')).transform(val => (val === '' || val === null) ? undefined : val),
});
...
const getStudents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const userBranchId = user === null || user === void 0 ? void 0 : user.branchId; // Assumes branchId is in the token or attached by middleware
...
const createStudent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!admissionNumber) {
            ...
            const lastStudent = yield prisma_1.prisma.student.findFirst({
                where: {
                    admissionNumber: {
                        startsWith: `${year}`
                    }
        ...
        if (data.guardianEmail) {
            ...
            const existingParent = yield prisma_1.prisma.user.findUnique({
            ...
            if (existingParent) {
                ...
                try {
                    const newParent = yield prisma_1.prisma.user.create({
                        data: {
          ...
          `;
                    ...
                    if (createError.code === 'P2002') {
                        ...
                        const retryParent = yield prisma_1.prisma.user.findUnique({
                            where: { email: data.guardianEmail }
                        });
                        if (retryParent) {
        ...
        const student = yield prisma_1.prisma.student.create({
            data: Object.assign(Object.assign({}, studentData), { classId: finalClassId, admissionNumber, status: 'ACTIVE', parentId, branchId: branchId }),
        });
...
const bulkCreateStudents = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingClasses = yield prisma_1.prisma.class.findMany({
        ...
        const result = yield prisma_1.prisma.student.createMany({
            data: dataToCreate,
            skipDuplicates: true,
        });
        res.status(201).json({
...
const updateStudent = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (data.classId) {
            const currentStudent = yield prisma_1.prisma.student.findUnique({
                where: { id },
                select: { classId: true }
            });
            if (currentStudent && currentStudent.classId !== data.classId) {
                yield prisma_1.prisma.classMovementLog.create({
                    data: {
                        studentId: id,
...
const getMyChildren = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId;
        // Get Active Term
        const activeTerm = yield prisma_1.prisma.academicTerm.findFirst({
            where: { isActive: true }
        });
        const students = yield prisma_1.prisma.student.findMany({
            where: {
        ...
        const studentsWithExtras = yield Promise.all(students.map((student) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (activeTerm) {
                ...
                for (const assessment of assessments) {
                    ...
                    const result = yield prisma_1.prisma.assessmentResult.findUnique({
                ...
                if (['MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY', 'FRIDAY'].includes(todayName)) {
                    todaysClasses = yield prisma_1.prisma.timetablePeriod.findMany({
                        where: {
