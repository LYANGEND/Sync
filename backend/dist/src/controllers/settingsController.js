...
const updateSettingsSchema = zod_1.z.object({
    ...
    // AI Configuration
    aiProvider: zod_1.z.string().optional().or(zod_1.z.literal('')),
    aiApiKey: zod_1.z.string().optional().or(zod_1.z.literal('')),
    aiModel: zod_1.z.string().optional().or(zod_1.z.literal('')),
    aiEnabled: zod_1.z.boolean().optional(),
    // WhatsApp Configuration
    whatsappProvider: zod_1.z.string().optional().or(zod_1.z.literal('')),
    whatsappApiKey: zod_1.z.string().optional().or(zod_1.z.literal('')),
    whatsappPhoneId: zod_1.z.string().optional().or(zod_1.z.literal('')),
    whatsappEnabled: zod_1.z.boolean().optional(),
});
const getSettings = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        let settings = yield prisma_1.prisma.schoolSettings.findFirst({
            include: {
                currentTerm: true
            }
        });
        if (!settings) {
            settings = yield prisma_1.prisma.schoolSettings.create({
                data: {
...
const updateSettings = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existing = yield prisma_1.prisma.schoolSettings.findFirst();
        let settings;
        if (existing) {
            settings = yield prisma_1.prisma.schoolSettings.update({
...
const deleteLogo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (existing && existing.logoUrl) {
            ...
            yield prisma_1.prisma.schoolSettings.update({
                where: { id: existing.id },
                data: { logoUrl: null },
            });
