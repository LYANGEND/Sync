...
router.get('/announcements/history', (0, authMiddleware_1.authorizeRole)(announcementRoles), communicationController_1.getAnnouncementHistory);
// Communication logs & stats (admin/bursar/secretary only)
const logViewRoles = ['SUPER_ADMIN', 'BURSAR', 'SECRETARY'];
router.get('/logs', (0, authMiddleware_1.authorizeRole)(logViewRoles), communicationController_1.getSentCommunications);
router.get('/stats', (0, authMiddleware_1.authorizeRole)(logViewRoles), communicationController_1.getCommunicationStatsHandler);
