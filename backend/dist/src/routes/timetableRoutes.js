...
router.get('/', (0, authMiddleware_1.authorizeRole)(['SUPER_ADMIN', 'TEACHER']), timetableController_1.getAllPeriods);
...
router.put('/:id', (0, authMiddleware_1.authorizeRole)(['SUPER_ADMIN', 'TEACHER']), timetableController_1.updateTimetablePeriod);
