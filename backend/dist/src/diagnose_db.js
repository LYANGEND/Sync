...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const classes = yield prisma_1.prisma.class.findMany({ take: 1 });
            console.log('Classes fetch success:', classes);
            console.log('Testing Subjects...');
            const subjects = yield prisma_1.prisma.subject.findMany({ take: 1 });
            console.log('Subjects fetch success:', subjects);
            console.log('Testing Payments...');
            const payments = yield prisma_1.prisma.payment.findMany({ take: 1 });
