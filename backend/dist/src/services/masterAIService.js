...
exports.masterAIService = void 0;
...
const tools = [
    // ===================== ACADEMIC CALENDAR =====================
    {
        ...
        execute: (params, userId) => __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
                ...
                try {
                    const event = yield prisma_1.prisma.academicEvent.create({
                        data: {
                            ...
                            isAllDay: (_a = ev.isAllDay) !== null && _a !== void 0 ? _a : true,
                            color: ev.color || null,
                            createdBy: userId,
                        },
                    });
                    ...
                    errors.push(`Event "${ev.title}": ${(_b = err.message) === null || _b === void 0 ? void 0 : _b.split('\n').pop()}`);
                }
            }
    ...
    },
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return prisma_1.prisma.academicEvent.findMany({ where, orderBy: { startDate: 'asc' }, take: 50 });
        }),
    },
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            if ((_a = params.ids) === null || _a === void 0 ? void 0 : _a.length) {
                const result = yield prisma_1.prisma.academicEvent.deleteMany({ where: { id: { in: params.ids } } });
                return { deleted: result.count };
            }
            if (params.eventType) {
                const result = yield prisma_1.prisma.academicEvent.deleteMany({ where: { eventType: params.eventType } });
                return { deleted: result.count };
            }
            return { deleted: 0 };
        }),
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            for (const s of students) {
                try {
                    ...
                    errors.push(`Student "${s.firstName} ${s.lastName}" (${s.admissionNumber}): ${(_a = err.message) === null || _a === void 0 ? void 0 : _a.split('\n').pop()}`);
                }
            }
    ...
    // ===================== CLASSES =====================
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let defaultTeacherId = (_b = (_a = params.classes) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.teacherId;
            let defaultTermId = (_d = (_c = params.classes) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.academicTermId;
            if (!defaultTeacherId) {
                const admin = yield prisma_1.prisma.user.findFirst({ where: { role: 'SUPER_ADMIN', isActive: true } });
                defaultTeacherId = admin === null || admin === void 0 ? void 0 : admin.id;
            }
            if (!defaultTermId) {
                const term = yield prisma_1.prisma.academicTerm.findFirst({ where: { isActive: true } });
                if (!term) {
                    const anyTerm = yield prisma_1.prisma.academicTerm.findFirst({ orderBy: { startDate: 'desc' } });
                    defaultTermId = anyTerm === null || anyTerm === void 0 ? void 0 : anyTerm.id;
                }
                else {
            ...
            for (const c of classes) {
                try {
                    ...
                    const existingClass = yield prisma_1.prisma.class.findFirst({ where: { name: c.name } });
                    if (existingClass) {
                        existing.push(existingClass);
                        continue;
                    }
                    const cls = yield prisma_1.prisma.class.create({
                        data: {
                            name: c.name,
                    ...
                    errors.push(`Class "${c.name}": ${(_e = err.message) === null || _e === void 0 ? void 0 : _e.split('\n').pop()}`);
                }
            }
    ...
    // ===================== SUBJECTS =====================
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            for (const s of subjects) {
                try {
                    const subj = yield prisma_1.prisma.subject.upsert({
                        where: { code: s.code },
                        update: { name: s.name },
                    ...
                    errors.push(`Subject "${s.name}" (${s.code}): ${(_a = err.message) === null || _a === void 0 ? void 0 : _a.split('\n').pop()}`);
                }
            }
            return { created, updated, errors, summary: `${created.length} created, ${updated.length} updated, ${errors.length} failed` };
        }),
    },
    {
        ...
        parameters: [],
        execute: () => __awaiter(void 0, void 0, void 0, function* () {
            return prisma_1.prisma.subject.findMany({ orderBy: { name: 'asc' } });
        }),
    },
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            for (const a of assignments) {
                try {
                    ...
                    let cls = null;
                    if (a.classId) {
                        cls = yield prisma_1.prisma.class.findUnique({ where: { id: a.classId } });
                    }
                    else if (a.className) {
                        cls = yield prisma_1.prisma.class.findFirst({ where: { name: { equals: a.className, mode: 'insensitive' } } });
                    }
                    if (!cls) {
                        errors.push(`Class "${a.className || a.classId}" not found`);
                        continue;
                    }
                    // Resolve subjects
                    const subjectIds = [];
                    if ((_a = a.subjectIds) === null || _a === void 0 ? void 0 : _a.length) {
                        subjectIds.push(...a.subjectIds);
                    }
                    if ((_b = a.subjectCodes) === null || _b === void 0 ? void 0 : _b.length) {
                        for (const code of a.subjectCodes) {
                            const sub = yield prisma_1.prisma.subject.findFirst({ where: { code: { equals: code, mode: 'insensitive' } } });
                            if (sub)
                                subjectIds.push(sub.id);
                            else
                                errors.push(`Subject code "${code}" not found`);
                        }
                    }
                    // Get already-linked subject IDs for this class
                    const existing = yield prisma_1.prisma.class.findUnique({ where: { id: cls.id }, select: { subjects: { select: { id: true } } } });
                    const existingIds = new Set(((existing === null || existing === void 0 ? void 0 : existing.subjects) || []).map((s) => s.id));
                    ...
                    errors.push(`Assignment error: ${(_c = err.message) === null || _c === void 0 ? void 0 : _c.split('\n').pop()}`);
                }
            }
    ...
    // ===================== SYLLABUS / TOPICS =====================
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (!subjectId && params.subjectCode) {
                const sub = yield prisma_1.prisma.subject.findFirst({ where: { code: { equals: params.subjectCode, mode: 'insensitive' } } });
                if (!sub)
                    return { error: `Subject with code "${params.subjectCode}" not found` };
                subjectId = sub.id;
            }
            if (!subjectId)
                return { error: 'Please provide subjectId or subjectCode' };
            const where = { subjectId };
            if (params.gradeLevel !== undefined)
                where.gradeLevel = Number(params.gradeLevel);
    ...
    },
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (subjectId) {
                subjectInfo = yield prisma_1.prisma.subject.findUnique({ where: { id: subjectId }, select: { id: true, name: true, code: true } });
            }
            else if (params.subjectCode) {
                subjectInfo = yield prisma_1.prisma.subject.findFirst({ where: { code: { equals: params.subjectCode, mode: 'insensitive' } }, select: { id: true, name: true, code: true } });
            }
            if (!subjectInfo)
                return { error: `Subject not found. Use list_subjects to find valid subjects.` };
            subjectId = subjectInfo.id;
            const gl = Number(params.gradeLevel);
            // Check if topics already exist
            const existingCount = yield prisma_1.prisma.topic.count({ where: { subjectId, gradeLevel: gl } });
            if (existingCount > 0) {
...
- Return ONLY the JSON, no other text`;
            const aiResponse = yield aiService_1.default.chat([{ role: 'user', content: prompt }], { temperature: 0.4, maxTokens: 4000 });
            // Parse AI response
            let syllabusData;
            try {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            for (const t of topicsArr) {
                try {
                    ...
                    errors.push(`Topic "${t.title}": ${(_a = err.message) === null || _a === void 0 ? void 0 : _a.split('\n').pop()}`);
                }
            }
    ...
    },
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const topics = yield prisma_1.prisma.topic.findMany({ where: { subjectId, gradeLevel: gl }, select: { id: true } });
            if (topics.length === 0)
                return { deleted: 0, summary: 'No topics found to delete' };
            // Delete subtopics first (cascade should handle this, but be safe)
            const subResult = yield prisma_1.prisma.subTopic.deleteMany({ where: { topicId: { in: topics.map(t => t.id) } } });
            // Delete progress
            yield prisma_1.prisma.topicProgress.deleteMany({ where: { topicId: { in: topics.map(t => t.id) } } }).catch(() => { });
            // Delete topics
            const result = yield prisma_1.prisma.topic.deleteMany({ where: { subjectId, gradeLevel: gl } });
    ...
    // ===================== LESSON PLANS =====================
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (params.subjectCode) {
                const subject = yield prisma_1.prisma.subject.findFirst({ where: { code: params.subjectCode } });
                if (subject)
    ...
    },
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            const plan = yield prisma_1.prisma.lessonPlan.findUnique({
                where: { id: params.id },
                include: {
                    subject: { select: { name: true, code: true } },
                    class: { select: { name: true, gradeLevel: true } },
            ...
            return {
                ...
                class: `${plan.class.name} (Grade ${plan.class.gradeLevel})`,
    ...
    // ===================== FEES =====================
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let defaultTermId = (_a = templates === null || templates === void 0 ? void 0 : templates[0]) === null || _a === void 0 ? void 0 : _a.academicTermId;
            if (!defaultTermId) {
                const term = (yield prisma_1.prisma.academicTerm.findFirst({ where: { isActive: true } })) || (yield prisma_1.prisma.academicTerm.findFirst({ orderBy: { startDate: 'desc' } }));
                defaultTermId = term === null || term === void 0 ? void 0 : term.id;
            }
            const created = [];
            const existing = [];
            const errors = [];
            for (const t of templates) {
                try {
                    ...
                    const existingTmpl = yield prisma_1.prisma.feeTemplate.findFirst({
                    ...
                    const tmpl = yield prisma_1.prisma.feeTemplate.create({
                        data: {
                            name: t.name,
                            amount: t.amount,
                    ...
                    errors.push(`Fee "${t.name}": ${(_b = err.message) === null || _b === void 0 ? void 0 : _b.split('\n').pop()}`);
                }
            }
            return { created, existing, errors, summary: `${created.length} created, ${existing.length} already existed, ${errors.length} failed` };
        }),
    },
    {
        ...
        parameters: [],
        execute: () => __awaiter(void 0, void 0, void 0, function* () {
            return prisma_1.prisma.feeTemplate.findMany({ orderBy: { name: 'asc' } });
        }),
    },
    // ===================== ACADEMIC TERMS =====================
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            for (const t of terms) {
                try {
                    ...
                    const existingTerm = yield prisma_1.prisma.academicTerm.findFirst({ where: { name: t.name } });
                    if (existingTerm) {
                        existing.push(existingTerm);
                        continue;
                    }
                    const term = yield prisma_1.prisma.academicTerm.create({
                        data: {
                            name: t.name,
                    ...
                    errors.push(`Term "${t.name}": ${(_a = err.message) === null || _a === void 0 ? void 0 : _a.split('\n').pop()}`);
                }
            }
            return { created, existing, errors, summary: `${created.length} created, ${existing.length} already existed, ${errors.length} failed` };
        }),
    },
    {
        ...
        parameters: [],
        execute: () => __awaiter(void 0, void 0, void 0, function* () {
            return prisma_1.prisma.academicTerm.findMany({ orderBy: { startDate: 'desc' } });
        }),
    },
    // ===================== ASSESSMENTS =====================
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            for (const a of assessments) {
                try {
                    ...
                    errors.push(`Assessment "${a.title}": ${(_a = err.message) === null || _a === void 0 ? void 0 : _a.split('\n').pop()}`);
                }
            }
            return { created, errors, summary: `${created.length} created, ${errors.length} failed` };
        }),
    ...
    // ===================== TIMETABLE =====================
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            // Find default term
            let defaultTermId = (_a = periods === null || periods === void 0 ? void 0 : periods[0]) === null || _a === void 0 ? void 0 : _a.academicTermId;
            if (!defaultTermId) {
                const term = (yield prisma_1.prisma.academicTerm.findFirst({ where: { isActive: true } })) || (yield prisma_1.prisma.academicTerm.findFirst({ orderBy: { startDate: 'desc' } }));
                defaultTermId = term === null || term === void 0 ? void 0 : term.id;
            }
            ...
            for (const p of periods) {
                try {
                    const period = yield prisma_1.prisma.timetablePeriod.create({
                        data: {
                    ...
                    // Link to class
                    if (p.classId) {
                        yield prisma_1.prisma.timetablePeriodClass.create({
                    ...
                    errors.push(`Period ${p.dayOfWeek} ${p.startTime}-${p.endTime}: ${(_b = err.message) === null || _b === void 0 ? void 0 : _b.split('\n').pop()}`);
                }
            }
            return { created, errors, summary: `${created.length} created, ${errors.length} failed` };
        }),
    ...
    // ===================== ANNOUNCEMENTS =====================
    {
        ...
        execute: (params, userId) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            for (const a of announcements) {
                try {
                    const ann = yield prisma_1.prisma.announcement.create({
                        data: {
                    ...
                    errors.push(`Announcement "${a.subject || a.title}": ${(_a = err.message) === null || _a === void 0 ? void 0 : _a.split('\n').pop()}`);
                }
            }
            return { created, errors, summary: `${created.length} created, ${errors.length} failed` };
        }),
    ...
    // ===================== NOTIFICATIONS =====================
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            for (const n of notifications) {
                try {
                    const notif = yield prisma_1.prisma.notification.create({
                        data: {
                            userId: n.userId,
                            title: n.title,
                            message: n.message,
                    ...
                    errors.push(`Notification for user ${n.userId}: ${(_a = err.message) === null || _a === void 0 ? void 0 : _a.split('\n').pop()}`);
                }
            }
    ...
    // ===================== SCHOOL STATISTICS =====================
    {
        ...
        parameters: [],
        execute: () => __awaiter(void 0, void 0, void 0, function* () {
            const [studentCount, teacherCount, classCount, subjectCount, termCount, eventCount] = yield Promise.all([
                ...
                prisma_1.prisma.academicTerm.count(),
                prisma_1.prisma.academicEvent.count(),
            ]);
            return {
    ...
    // ===================== SCHOLARSHIPS =====================
    {
        ...
        execute: (params) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            const scholarships = params.scholarships;
            const created = [];
            const existing = [];
            const errors = [];
            for (const s of scholarships) {
                try {
                    ...
                    const existingSch = yield prisma_1.prisma.scholarship.findFirst({ where: { name: s.name } });
                    if (existingSch) {
                        existing.push(existingSch);
                        continue;
                    }
                    const sch = yield prisma_1.prisma.scholarship.create({
                        data: {
                            name: s.name,
                    ...
                    errors.push(`Scholarship "${s.name}": ${(_a = err.message) === null || _a === void 0 ? void 0 : _a.split('\n').pop()}`);
                }
            }
            return { created, existing, errors, summary: `${created.length} created, ${existing.length} already existed, ${errors.length} failed` };
        }),
        ...
        execute: (params, userId) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            for (let i = 0; i < expenses.length; i++) {
                try {
                    ...
                    errors.push(`Expense "${(_a = expenses[i]) === null || _a === void 0 ? void 0 : _a.description}": ${(_b = err.message) === null || _b === void 0 ? void 0 : _b.split('\n').pop()}`);
                }
            }
            return { created, errors, summary: `${created.length} created, ${errors.length} failed` };
        }),
...
function buildToolDescriptions() {
    return tools.map(t => {
        const params = t.parameters.length > 0
            ? '\n    Parameters:\n' + t.parameters.map(p => `      - ${p.name} (${p.type}${p.required ? ', required' : ''}): ${p.description}${p.enum ? ` [${p.enum.join(', ')}]` : ''}`).join('\n')
            : '\n    Parameters: none';
...
class MasterAIService {
     ...
     */
    processCommand(userMessage, userId, conversationHistory) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const action of (plan.actions || [])) {
                ...
                try {
                    const data = yield toolDef.execute(action.params || {}, userId);
                    ...
                    let summaryText;
                    if ((data === null || data === void 0 ? void 0 : data.summary) && typeof data.summary === 'string') {
                        // New resilient format: { created: [], updated?: [], existing?: [], errors: [], summary: string }
                        const hasErrors = ((_a = data.errors) === null || _a === void 0 ? void 0 : _a.length) > 0;
                        ...
                        const count = (_b = data === null || data === void 0 ? void 0 : data.deleted) !== null && _b !== void 0 ? _b : 1;
            ...
            try {
                finalMessage = yield this.buildAccurateSummary(userMessage, results, plan.message);
            }
            catch (_c) {
            ...
            // Log usage
            try {
                yield prisma_1.prisma.aIUsageLog.create({
                    data: {
                        userId,
     ...
     */
    buildAccurateSummary(userMessage, results, fallbackMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const dataSnapshot = successResults.map(r => {
                ...
                let compactData = r.data;
                // Trim large arrays to keep token usage low
                if ((compactData === null || compactData === void 0 ? void 0 : compactData.created) && Array.isArray(compactData.created)) {
                    compactData = Object.assign(Object.assign({}, compactData), { created: compactData.created.slice(0, 5).map((item) => {
                            const { id, schoolId, createdAt, updatedAt } = item, rest = __rest(item, ["id", "schoolId", "createdAt", "updatedAt"]);
                            return rest;
                        }), _totalCreated: compactData.created.length });
                }
                if (Array.isArray(compactData) && compactData.length > 10) {
                    compactData = { items: compactData.slice(0, 5).map((item) => {
                            const { id, schoolId, createdAt, updatedAt } = item, rest = __rest(item, ["id", "schoolId", "createdAt", "updatedAt"]);
                            return rest;
                ...
                if (compactData && typeof compactData === 'object' && !Array.isArray(compactData)) {
                    const { id, schoolId, createdAt, updatedAt } = compactData, rest = __rest(compactData, ["id", "schoolId", "createdAt", "updatedAt"]);
...
- Respond with ONLY the message text, nothing else.`;
            try {
                const summaryResponse = yield aiService_1.default.chat([
...
exports.masterAIService = new MasterAIService();
