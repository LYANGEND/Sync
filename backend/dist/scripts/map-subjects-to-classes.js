...
function getSubjectCodesForGradeLevel(gradeLevel) {
    if (gradeLevel <= 0)
        return ECE_SUBJECTS;
    if (gradeLevel <= 4)
    ...
    if (gradeLevel <= 9)
        return [...FORM_1_2_CORE, ...FORM_1_2_ELECTIVES];
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const teacher = yield prisma_1.prisma.user.findFirst({
        ...
        const allSubjects = yield prisma_1.prisma.subject.findMany();
        ...
        for (const cls of CLASSES_TO_ENSURE) {
            ...
            yield prisma_1.prisma.class.create({
                data: {
                    name: cls.name,
        ...
        const allClasses = yield prisma_1.prisma.class.findMany({
            select: { id: true, name: true, gradeLevel: true },
        ...
        const finalClasses = yield prisma_1.prisma.class.findMany({
